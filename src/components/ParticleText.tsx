...
const resolveFontSize = (value: any, container: HTMLElement, fontWeight: any, fontFamily: string) => {
...
const ParticleText = ({
  ...
  useEffect(() => {
    ...
    const sampleText = async () => {
      ...
      for (let y = 0; y < offscreen.height; y += step) {
        for (let x = 0; x < offscreen.width; x += step) {
          ...
          if (alpha > 40) {
            targets.push({
              x: x, // Align to left edge instead of center
    ...
    canvas.addEventListener('pointerenter', handlePointerEnter as EventListener);
    ...
    return () => {
      ...
      canvas.removeEventListener('pointerenter', handlePointerEnter as EventListener);
